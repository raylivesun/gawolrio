...
abstract mixin class MapBase<K, V> implements Map<K, V> {
  ...
  static get toStringVisiting => null;
  ...
  _MapBaseValueIterable<dynamic, dynamic> get callback => _MapBaseValueIterable<K, V>(this);
  Future<String Function()> toStr() async => mapToString(this);

  static String Function() mapToString(Map<Object?, Object?> m) {
...
class _MapBaseValueIterable<K, V> {
  final Map<K, V> _map;
  ...
  //  implement len
  int get len => throw UnimplementedError();
}
...
abstract class EfficientLengthIterable {
  int get len;
}
